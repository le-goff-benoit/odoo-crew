...
Ne transforme pas ces propositions en comportement à implémenter, critères définitifs
ou décisions actées. Avance sur la partie indépendante de cet arbitrage.
...
- Une décision structurante confirmée par le client, avec sa provenance (arbitrage métier, périmètre
...
Sans accès aux preuves, laisse le verdict standard et la voie technique non établis.
Dans la mémoire, sépare décisions sourcées, propositions et état réel de réalisation.
