"""Postconditions D-03 sur la copie lab_client apres une seconde mise a niveau."""
attendu = {
    'Location 3 jours': 30.0,
    'Location 4 jours': 40.0,
    'Location 7 jours': 155.0,
    'Location 5 jours tarif nul': 15.0,
    'Location vide': 0.0,
    'Pret 4 jours': 40.0,
    'Pret 10 jours': 100.0,
}
...
print('VUES', vues, 'ACTIONS', actions, 'MENUS', menus, 'REGLES', regles)
...
print('DEPENDANCES', sorted(env['ir.module.module.dependency'].search([('module_id', '=', module.id)]).mapped('name')))
