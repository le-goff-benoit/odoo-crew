...
## Conditions de complétion après QA

La réception indépendante doit passer avant la publication exacte des deux mémoires. L’orchestrateur termine ensuite le flow et reçoit la tâche du plan avec une preuve valide et un fragment de consolidation. La release reste ouverte. Ces obligations AC12 demeurent requises pour déclarer la tâche terminée ; elles ne sont pas présentées comme déjà réalisées dans les preuves QA qui les précèdent.
