...
for attempt in (1, 2):
    ...
    print('MIGRATION_PASS=' + str(attempt) + ' SQL/ORM/entrées métier OK')
env.cr.commit()
print('COPY_AFTER=' + json.dumps(records.read([*inputs, 'write_date', 'amount_total']), ensure_ascii=False, default=str))
