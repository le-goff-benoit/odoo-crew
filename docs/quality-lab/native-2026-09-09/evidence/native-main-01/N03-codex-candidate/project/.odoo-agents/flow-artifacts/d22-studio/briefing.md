...
Confirmation : LAB.md et .odoo-agents/config déclarent explicitement 19.0. Copie synthétique lab_client via XML-RPC local, selon LAB.md. Aucun module custom.
