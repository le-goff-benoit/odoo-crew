...
Périmètre retenu : **pilote court L00–L04 et validation de ce pilote**.
L05–L09 décrivent les suites possibles ; ils ne sont pas requis pour terminer ce pilote.
...
| L05 | Corriger les pertes du briefing (M01–M03) | L00 | à faire | Tests rouges puis verts, ancienne référence préservée |
| L06 | Fiabiliser les verdicts QA, preuves et protections (R03–R11) | L00 | à faire | Cas de contrat isolés, défauts distincts |
| L07 | Organisation des tâches, mémoire et documentation | L05, L06 | à faire | Critères sections 10, 13, 14, compatibles avec l’existant |
| L08 | Variantes et comparaison contrôlée des directives | L04, L06 | à faire | Évaluation indépendante, corpus réservé |
| L09 | Validation intégrée et livraison réversible | L07, L08 | à faire | Aucun gain annoncé sans résultat mesuré |
