...
la mise à jour ; vérifier cette correspondance reste un préalable humain.
...
Toute migration nouvelle/modifiée requiert cette preuve d'exécution. Une version
...
- Scripts nouveaux/modifiés sous `migrations/` ou `upgrades/` : nom
  ...
  Cette plage suit la [documentation officielle Odoo 19.0](https://www.odoo.com/documentation/19.0/developer/reference/upgrades/upgrade_scripts.html),
