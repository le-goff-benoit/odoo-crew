# Banc Odoo — 20260908-223929-5a646622
...
|---|---|---|---:|---|
| B13-claude-dev_guard-r1 | claude | completed | 43.8 | accepted |

## Configurations et mesure

| Essai | Modèle demandé | Effort demandé | Modèle observé |
|---|---|---|---|
| B13-claude-dev_guard-r1 | opus | medium | claude-opus-5 |
...
|---|---|---|---|---|
| B13-claude-dev_guard-r1 | non mesuré | 1/1 | non mesuré | non mesuré |
