...
def self_test():
    ...
    for task, start in [('a', 1), ('b', 2)]:
        rows.append(event(start, type='system', subtype='task_started', task_id=task, tool_use_id=task, subagent_type='fixture'))
    ...
    print('Calibration : demande seule, absence de progression, chevauchement, interruption, témoin séquentiel et simple revendication contrôlés.')
